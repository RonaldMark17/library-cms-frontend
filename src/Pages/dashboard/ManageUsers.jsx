...
export default function ManageUsers() {
  ...
  const API_URL = import.meta.env.VITE_API_URL || ""; // Environment-based API URL
                ...
                <tr key={user.id} className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <td className="py-3 px-4 flex space-x-2">
                    ...
                    <button
                      ...
                      className="text-red-600 hover:text-red-700 dark:text-red-400 flex items-center space-x-1"
                    >
